...
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠙⠻⠶⠦⠤⠶⠧⠾⠋⠁⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
    ...
    \033[1;91m✨𝙲𝙾𝙽𝚃𝙰𝙲𝚃 𝙲𝚁𝙸𝚂𝙹𝙷𝙾𝙽 𝙿 𝙳𝙴𝙶𝚄𝙸𝙽𝙾𝙽 𝙵𝙾𝚁 𝙿𝙰𝚂𝚂 𝙰𝙽𝙳 𝚄𝚂𝙴𝚁✨
    
                
 ⚡ \33[0;32m𝙻𝙾𝙶𝙸𝙽 𝚃𝙾 𝚂𝙿𝙴𝙲𝚃𝚁𝙴𝚃𝙾𝙾𝙻𝚂:  """)
...
☠️ \033[1;31;40m𝚃𝙰𝙽𝙶 𝙸𝙽𝙰 𝙼𝙾 𝚆𝚁𝙾𝙽𝙶 𝙿𝙰𝚂𝚂 𝙺𝙰 𝙾𝚁 𝚄𝚂𝙴𝚁 𝙿𝙼 𝙼𝙾 𝚂𝙸 𝙲𝚁𝙸𝚂𝙹𝙷𝙾𝙽 𝙿𝙰𝚁𝙰 𝙼𝙰𝙺𝚄𝙷𝙰 𝚈𝚄𝙽𝙶 𝚄𝚂𝙴𝚁 𝙾𝚁 𝙿𝙰𝚂𝚂""")
        time.sleep(3)
        sys.exit(1)
    elif username == user and password == passwd:
        print("""                                     
        
⚡ \33[0;91m𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙿𝙴𝙲𝚃𝚁𝙴𝙴𝚃𝙾𝙾𝙻𝚂""")
        time.sleep(2)
...
def ip():
    ...
    print(f"{c}   「{w}User{c}」{w}:{c}Member {r}")
    linex()
...
def menu():
    ...
    menu_actions = {
        ...
        '2': QuickReact,
        '3': C_page,
        '4': lambda: print(f"{red}Coming Soon..."),
        '5': lambda: print(f"{red} Before following get token first .{r}"),
        '6': comment_on_facebook_post,
        '7': AutomaticSharing,
        '8': TOKEN,
        '9': IP,
        '10': lambda: print(f"{red}Coming Soon..."),
        '11': lambda: reset(),
...
def AutomaticSharing():
    ...
    def share_post():
        ...
        try:
            ...
            print(f' {c}「Success」»  {c}「{wh}{shared_count}{c}」» {wh} ID:{c}{post_id or "Failed."}{wh}')
...
def TOKEN():
    e = input('\033[0m [›] Email/Usn/Id:\033[90m ')
...
def lookup_ip(ip):
    url = "https://deku-rest-api.gleeze.com/iplu?ip="
    params = {'ip': ip}
